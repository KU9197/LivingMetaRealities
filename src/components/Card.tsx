...
export default function Card({ title, actions, children }: Props) {
  return (
    <section className="rounded-2xl border border-neutral-200 bg-white p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col h-full w-full">
      {(title || actions) && (
